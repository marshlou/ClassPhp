...
Last login: Wed Feb 19 13:29:42 on console
Designs-iMac-4:~ designstudio_11$ git credential-osxkeychain erase
error: git-credential-osxkeychain died of signal 11
Designs-iMac-4:~ designstudio_11$ git config --global credential.helper cache
Designs-iMac-4:~ designstudio_11$ git credential-osxkeychain erase
error: git-credential-osxkeychain died of signal 11
Designs-iMac-4:~ designstudio_11$
Last login: Tue Apr  1 09:03:05 on console
Designs-iMac-4:~ designstudio_11$ cd /usr/local/bin
Designs-iMac-4:bin designstudio_11$ ls
git				git-upload-pack
git-credential-osxkeychain	github
git-cvsserver			node
git-receive-pack		npm
git-shell			pstorm
git-upload-archive
Designs-iMac-4:bin designstudio_11$ sudo
...
name|#uid] [-g groupname|#gid] [VAR=value] [-i|-s] [<command>]
    ...
    name|#uid] file ...
    Designs-iMac-4:bin designstudio_11$ sudo npm install-g coffee-script
    Password:
        ...
        where <command> is one of:
            ...
            npm <cmd> -h     quick help on <cmd>
                    ...
                    npm help <term>  search for help on <term>
                            ...
                            /Users/designstudio_11/.npmrc
                            or on the command line via: npm <command> --key value
                                Config info can be viewed via: npm help config

                                npm@1.4.3 /usr/local/lib/node_modules/npm
                                Designs-iMac-4:bin designstudio_11$ sudo npm install-g less
                                        ...
                                        npm <cmd> -h     quick help on <cmd>
                                                ...
                                                npm help <term>  search for help on <term>
                                                        ...
                                                        or on the command line via: npm <command> --key value
                                                            ...
                                                            └── request@2.34.0 (forever-agent@0.5.2, json-stringify-safe@5.0.0, tunnel-agent@0.3.0, aws-sign2@0.5.0, oauth-sign@0.3.0, qs@0.6.6, node-uuid@1.4.1, tough-cookie@0.12.1, hawk@1.0.0, http-signature@0.10.0, form-data@0.1.2)
                                                            Designs-iMac-4:bin designstudio_11$ sudo npm install -g coffee-script
                                                            ...
                                                            └── mkdirp@0.3.5
                                                            Designs-iMac-4:bin designstudio_11$
